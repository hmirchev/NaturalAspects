...
public class NaturalAspectsParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("NaturalAspects");
  ...
  { 
    NaturalAspectsParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = NaturalAspectsParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = NaturalAspectsParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(NaturalAspectsParseControllerGenerated.class);
    }
  ...
  { 
    return NaturalAspectsParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
